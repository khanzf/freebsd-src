/*-
 * Copyright (c) 2026 Farhan Khan <farhan@farhan.codes>
 *
...
static void
r10bu_set_macaddr(struct rtwn_softc *sc, uint8_t *buf)
{
#if 0
...
static void
r88g_postattach(struct rtwn_softc *sc)
{
#if 0
